        ...
        <div class="container">
          ...
          <div class="content">
            ...
            <p style="text-align: center;">
              <a href="${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'}/track/${trackingNumber}" class="button">
...
Track your submission: ${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'}/track/${trackingNumber}
