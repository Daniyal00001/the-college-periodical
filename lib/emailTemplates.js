...
export function getResubmissionConfirmationEmail(authorName, articleTitle, trackingNumber) {
  return {
    subject: `Article Resubmission Received - ${trackingNumber}`,
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h2 style="color: #2563eb;">Article Resubmission Received</h2>
        <p>Dear ${authorName},</p>
        <p>We have successfully received your revised article submission.</p>
        
        <div style="background-color: #f3f4f6; padding: 15px; border-radius: 5px; margin: 20px 0;">
          <strong>Article Details:</strong><br>
          Title: ${articleTitle}<br>
          Tracking Number: ${trackingNumber}
        </div>
        
        <p>Your revised article will be reviewed by our editorial team. We appreciate the time you took to address the feedback.</p>
        
        <p>You can expect to hear from us within 2-4 weeks regarding the status of your resubmission.</p>
        
        <p>If you have any questions, please don't hesitate to reach out.</p>
        
        <p>Best regards,<br>
        The College Periodical Editorial Team</p>
      </div>
    `,
    text: `
Dear ${authorName},

We have successfully received your revised article submission.

Article Details:
Title: ${articleTitle}
Tracking Number: ${trackingNumber}

Your revised article will be reviewed by our editorial team. We appreciate the time you took to address the feedback.

You can expect to hear from us within 2-4 weeks regarding the status of your resubmission.

Best regards,
The College Periodical Editorial Team
    `
  }
}
